function scoreChange(a) {
    function e() {
        var b = document.getElementById("doughnutChartCanvas").getContext("2d");                                                                                             /* href="javascript:void(0);" onclick="onLinePreview()"*/
        new Chart(b).Doughnut(c, d), $("#resumeScore .scoreVal span").text(a).parent().fadeIn(200), 100 == a ? $("#resumeScore .which span").html('<a href="/preview/findResume"  target="_blank">马上去投递</a>') : $("#resumeScore .which span").html("<a>马上去完善</a>")
    }
...
!function (a, b) {
    ...
    window.onbeforeunload = function () {
        ...
        a.stopPropagation();
        var b = $(this).text();
        $("#select_topDegree").val(b).css("color", "#333").removeClass("select_focus"), $("#topDegree").val(b), $("#box_topDegree").hide(),
        ...
        a.stopPropagation();
        var b = $(this).text();
        $("#select_workyear").val(b).css("color", "#333").removeClass("select_focus"), $("#workyear").val(b), $("#box_workyear").hide(),
        ...
        a.stopPropagation();
        var b = $(this).text();
        $("#select_currentState").val(b).css("color", "#333").removeClass("select_focus"), $("#currentState").val(b), $("#box_currentState").hide(),
        ...
        a.stopPropagation();
        var b = $(this).text();
        $("#select_expectSalary").val(b).css("color", "#333").removeClass("select_focus"), $("#expectSalary").val(b), $("#box_expectSalary").hide(),
