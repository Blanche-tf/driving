$(function () {
    $(window).resize(function () {
        ...
        minLength: 0, source: function (a, b) {
            ...
            return $("#searchForm").attr("action", ctx ), $("#search_button").trigger("click", b.item.type), !1
        }
    }), $("#search_button").click(function (a, b) {
        var c, d, e;
        b && $("#spcInput").val(b), c = $.trim($("#search_input").val()), ("请输入职位名称，如：产品经理" == c || "请输入公司名称，如：拉勾" == c) && (c = ""), d = /[\\\/]/g, e = c.replace(d, " "), e = encodeURIComponent(e), $("#labelWords").val(""), "" == e ? $("#searchForm").attr("action", ctx).submit() : $("#searchForm").attr("action", ctx ).submit()
        ...
        return a = a.replace(b, " "), a = encodeURIComponent(a), $(this).attr("action", ctx ), !0
    })
});